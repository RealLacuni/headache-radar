...
const Hero = () => {
    return (
        <div className={"grid py-8 px-1 gap-8 lg:gap-2 grid-cols-1 grid-rows-8 lg:grid-cols-4 items-center"}>
            ...
            <p className={"text-slate-200 pt-10 lg:pt-10 row-start-2 col-start-1 col-end-3 text-xl font-normal leading-loose"}>At
                a glance..
                <br/> be notified of
            ...
            <div className={"flex gap-2 lg:gap-4  pt-20 row-start-3 items-baseline col-start-1 lg:col-start-1 lg:col-end-3"}>
                <Card><p>Check the upcoming weather forecasts with up to five days of weather data.</p>
                </Card>
                <Card>
