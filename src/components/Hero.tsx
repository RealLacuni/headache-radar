...
const Hero = () => {
    ...
    return (
        <div className={"grid pt-20 gap-y-20 pl-4 grid-cols-1 grid-rows-8 lg:grid-cols-12 items-center"}>
            ...
            <div
                className={"flex flex-col items-center gap-8 lg:gap-12 text-gray-300 lg:text-xl row-start-4 lg:flex-row lg:row-start-4 lg:col-start-1 lg:col-end-12"}>
            ...
            <div id={"img-container"}
                ...
                <div id={"img-wrapper"} className={"relative left-36 lg:left-96 w-fit drop-shadow-md border-slate-950 border-8 rounded-xl shadow-black shadow-lg"}>
