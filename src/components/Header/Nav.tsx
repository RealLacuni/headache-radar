...
import {RadarIcon} from '../../assets/svg/Icons.tsx'
    ...
    return (
        <header className="flex justify-between items-start p-2 h-12 text-xl">
            <div className={"relative text-xs font-semibold text-gray-400 flex self-center flex-col items-end p-1 z-20"}>
                Headache <span className={"text-secondary-600 font-semibold"}>Radar</span> <RadarIcon className={"absolute fill-secondary-600 left-1 top-[1.25rem] h-4 w-4"}/>
            </div>
